// Web-push helpers voor de horeca-omgeving: service worker registreren,
...
export async function enablePush(vapidPublicKey, lang) {
    ...
    const res = await fetch(`${API_URL}/api/horeca/public/push/subscribe`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'X-Horeca-Pincode': getStoredPincode() },
...
export async function disablePush() {
    ...
    if (sub) {
        try {
            await fetch(`${API_URL}/api/horeca/public/push/unsubscribe`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-Horeca-Pincode': getStoredPincode() },
